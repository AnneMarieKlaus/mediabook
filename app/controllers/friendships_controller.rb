class FriendshipsController < ApplicationController
	...
	def create
		...
		respond_to do |format|
			format.html { redirect_to users_url, notice: "Friendship created"}
		end
	end
	...
	def accept
		...
		respond_to do |format|
			format.html { redirect_to users_url, notice: "Friendship Accepted!"}
		end
	end
	...
	def destroy
		@friendship.destroy
		respond_to do |format|
			format.html { redirect_to users_url, notice: "Friendship destroyed"}
		end
	end
